...
instr PlayInterval ; p4, p5, interval in MIDI notes, p6 - if melodic, 0 - play harmoniically
	...
	if (iMelodic>=1) then
		...
		schedule "PlayNote", 0, giShort, iNote1, 1
		schedule "PlayNote", iDuration, giShort, iNote2, 0.6
	else
		iDuration = 2*i(gkBeatLength)
		schedule "PlayNote", 0, giLong, iNote1, 0.8
		schedule "PlayNote", 0, giLong, iNote2, 0.4
	endif
