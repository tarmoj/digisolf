...
const AskDegreeDictation = () => {
    ...
    const generateDegreeDictation = () => {
        ...
        const followUpProbabilitiesSimple = { // probabilities, what comes after the given degree
            ...
            "2": {3:0.45 , 1:0.25, 4:0.1, "-7":0.1 },
            "3": {4:0.45 , 1:0.25, 2:0.1, 5:0.1 },
            "4": {5:0.45 , 2:0.25, 1:0.1, 6:0.1 },
            "5": {6:0.4 , 4:0.3, 1:0.2, 3:0.1 },

            "6": {5:0.45 , 4:0.25, 7:0.1, 2:0.1  },
            "7": {8:0.4 , 6:0.3, 5:0.2, 2:0.1 },
        ...
        const followUpProbabilitiesMedium = { // probabilities, what comes after the given degree
            "1": {4:0.4 , 3:0.2, 5:0.1, 6:0.25, "-5":0.05  }, // give 5 steps, probabilities must sum to 1, like 0.4, 0.25, 0.2, 0.1, 0.05)
            "2": {4:0.4 , 7:0.3, 6:0.1,  "-5":0.1  },
            "3": {"-7":0.4 , 6:0.3, 2:0.2, 5:0.1  },
            "4": {"-7":0.4 , 5:0.3, 1:0.2, 6:0.1  },
            "5": {"-5":0.4 , 2:0.25, 1:0.1, 3:0.1, "-7":0.05  },

            "6": {2:0.25, 7:0.25, 4:0.25, 1:0.25  },
            "7": {6:0.4 , 5:0.25, 2:0.1, 4:0.1, "-7":0.05  },
            "-7": {1:0.5 , 2:0.25, "-5":0.15, 4:0.1  },
            "-6": {"-5":0.4 , 2:0.3, 1:0.2, 4:0.1  },
